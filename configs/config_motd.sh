...
sudo cp /tmp/motd_cloudflare /etc/motd_cloudflare
...
echo 'cat /etc/motd_cloudflare' >> /etc/profile
echo '(tput setaf 6)' >> /etc/profile
...
echo 'echo '🅷🅾🅼🅴 :'' 'https://www.cloudflare.com/pt-br/' >> /etc/profile
echo 'echo '🅳🅾🅲🆂 :'' 'https://www.cloudflare.com/pt-br/connectivity-cloud/' >> /etc/profile
echo 'echo ''' >> /etc/profile
