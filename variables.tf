...
variable "motd_cloudflare_path" {
  description = "Caminho para o arquivo de MOTD do Clouflare"
  type        = string
}
...
variable "env_cloudflared_token_path" {
  description = "Caminho para o arquivo '.env' com Token do Cloudflare Tunnel"
  type        = string
  sensitive   = true
}
